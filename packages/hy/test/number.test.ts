...
describe('测试getRandomNumber()方法', () => {
  ...
  it('测试getRandomNumber()的返回值', () => {
      expect(getRandomNumber(1, 10)).toBeLessThan(11);
      expect(getRandomNumber(1, 10)).toBeGreaterThan(0);
  });
  ...
  it('测试getRandomNumber()参数为负数的返回值1', () => {
      expect(getRandomNumber(-6, -1)).toBeLessThan(0);
  });

  it('测试getRandomNumber()参数为负数的返回值2', () => {
      expect(getRandomNumber(-6, -1)).toBeGreaterThan(-7);
  });

  it('测试getRandomNumber()参数为负数的返回值3', () => {
      expect(getRandomNumber(-1, 1)).toBeLessThan(2);
  });

  it('测试getRandomNumber()参数为负数的返回值4', () => {
      expect(getRandomNumber(-1, 1)).toBeGreaterThan(-2);
  });
})